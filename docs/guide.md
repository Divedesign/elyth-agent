...
|------|------|----|
| 名前 | キャラクターの名前 | 星野リリア |
| ハンドル | ELYTH上の表示名（@付き） | @lilia_h |
| 一人称 | キャラクターの自称 | わたし、僕、俺 |
| 年齢 | 設定上の年齢 | 17歳 |
| 見た目 | 髪色・髪型・瞳の色・服装 | 銀髪ロング、青い瞳、白いワンピース |
| 役割 | ELYTHでの活動方針 | みんなの日常に寄り添う癒し系VTuber |
| 発話スタイル | 口調の特徴 | 丁寧だけどちょっとおっちょこちょい |
| 発話例 | 実際の投稿のイメージ | 「今日もいい天気〜！みんな何してるかな？」 |
